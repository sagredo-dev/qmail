...
void hier()
{
  ...
  c(auto_qmail,"doc","doc/INSTALL",auto_uido,auto_gidq,0644);
  c(auto_qmail,"doc","doc/INSTALL.alias",auto_uido,auto_gidq,0644);
  c(auto_qmail,"doc","doc/INSTALL.ctl",auto_uido,auto_gidq,0644);
  c(auto_qmail,"doc","doc/INSTALL.ids",auto_uido,auto_gidq,0644);
  c(auto_qmail,"doc","doc/INSTALL.maildir",auto_uido,auto_gidq,0644);
  c(auto_qmail,"doc","doc/INSTALL.mbox",auto_uido,auto_gidq,0644);
  c(auto_qmail,"doc","doc/INTERNALS",auto_uido,auto_gidq,0644);
  c(auto_qmail,"doc","doc/INSTALL.vsm",auto_uido,auto_gidq,0644);
  c(auto_qmail,"doc","doc/TEST.deliver",auto_uido,auto_gidq,0644);
  c(auto_qmail,"doc","doc/TEST.receive",auto_uido,auto_gidq,0644);
  c(auto_qmail,"doc","doc/REMOVE.sendmail",auto_uido,auto_gidq,0644);
  c(auto_qmail,"doc","doc/REMOVE.binmail",auto_uido,auto_gidq,0644);
  c(auto_qmail,"doc","doc/README.auth",auto_uido,auto_gidq,0644);
  c(auto_qmail,"doc","doc/README.dnsbl",auto_uido,auto_gidq,0644);
  c(auto_qmail,"doc","doc/README.empf",auto_uido,auto_gidq,0644);
  c(auto_qmail,"doc","doc/README.exttodo",auto_uido,auto_gidq,0644);
  c(auto_qmail,"doc","doc/README.liberal-lf",auto_uido,auto_gidq,0644);
  c(auto_qmail,"doc","doc/README.maxrcpt",auto_uido,auto_gidq,0644);
  ...
  c(auto_qmail,"bin","qmail-qfilter",auto_uido,auto_gidq,0711);
  ...
  c(auto_qmail,"man/man8","qmail-qfilter.8",auto_uido,auto_gidq,0644);
  c(auto_qmail,"man/cat8","qmail-qfilter.0",auto_uido,auto_gidq,0644);
