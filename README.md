...
* Alex Nee's qmail-hide-ip-headers patch  
  ...
  authenticated.
  - [original patch](https://notes.sagredo.eu/files/qmail/patches/qmail-hide-ip-headers.patch)
...
* Andreas Gerstlauer's Server Name Indication (SNI) support  
  ...
  - [More info](https://notes.sagredo.eu/en/qmail-notes-185/server-name-indication-sni-for-qmail-and-dovecot-331.html)
...
* Pierluigi's qmail-remote auth method select  
  ...
  - [More info here](https://notes.sagredo.eu/qmail-notes-185/smtp-auth-qmail-tls-forcetls-patch-for-qmail-84.html#comment5058)
